...
from fleet_care.cli import main
from fleet_care.models import Note, ProjectState, Task
from fleet_care.cli import demo_state
from fleet_care.storage import load_state, save_state
from fleet_care.models import generate_short_id
from fleet_care.validation import normalize_tags, require_text, validate_task_status
from fleet_care.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
